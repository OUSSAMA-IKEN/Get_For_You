    ...
    <footer id="contact" className="relative bg-card/50 border-t border-border/50">
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <div className="text-2xl font-bold bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent mb-4">
              SoundWave Pro
            </div>
            <p className="text-muted-foreground leading-relaxed mb-6 max-w-md">
              Découvrez une nouvelle dimension sonore avec nos écouteurs premium. 
              Qualité, innovation et design pour une expérience audio exceptionnelle.
            </p>
