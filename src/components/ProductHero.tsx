...
const ProductHero = ({
  ...
  return (
    <section className="min-h-screen mx-auto flex items-center relative">
      {/* Background spots */}
            ...
            <div className="w-full h-auto flex justify-center relative lg:right-16">
              <div className="flex flex-col items-center">
                <div className="flex justify-center rotate-12">
                  <img
                    src={productImage}
                    alt={t("SoundWave Pro Headphones")}
          ...
          >
            ...
            >
              <span className="bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">
                {t("Smart Lint Remover")}
              </span>
              <br />
              <span className="text-foreground">{t("Pro")}</span>
            </motion.h1>
            ...
            >
              <span className="text-lg font-medium ml-3">{t("Quantity")}:</span>
